...
/* ID PARA ATUALIAR PARA O SEXO FEMININO
	11 12 16 17*/
	SELECT * FROM CLIENTE WHERE IDCLIENTE = 11;
	UPDATE CLIENTE SET SEXO = 'F' WHERE IDCLIENTE = 11;
	UPDATE CLIENTE SET SEXO = 'F' WHERE IDCLIENTE = 12;
	UPDATE CLIENTE SET SEXO = 'F' WHERE IDCLIENTE = 16;
...
/* QUANTIDADE DE HOMENS E MULHERES */
	SELECT COUNT(*) AS 'QUANTIDADE POR SEXO', SEXO
	FROM CLIENTE
	GROUP BY SEXO;

/*ID E EMAILS DAS MULHERES QUE MORAM NO CENTRO DO RIO DE JANEIRO E NÃO TENHAM CELULAR */
